            ...
            google.maps.event.addListener(marker, 'dragend', function(event) {
                ...
                $.ajax({
                    ...
                    for (var i = 0; i < years.length; i++) {
                        if (typeof serverData.features[0].properties[yearsWords[i]] === 'undefined') {
                            console.log('skip');
                        } else {
                    ...
                    if (typeof serverData.features[0].properties['trend'] === 'undefined') {
                        console.log('skip trend');
                    } else {
                        contentString = contentString.concat("<div><p>The rising likelihood of the property price was " + serverData.features[0].properties['trend'] + "%</p>considering its neighbors and its own historical trend.  </div>")
                    }
